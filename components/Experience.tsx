...
const experiences = [
  {
    ...
    type: 'Onsite',
    description: [
      'Built and maintained responsive web applications with React and Next.js, focusing on clean UI, performance, and accessibility.',
      'Developed backend services and REST APIs using Python/Django for scalable data-driven features.',
      'Improved performance with caching strategies, lazy loading, and Core Web Vitals optimizations.',
      'Implemented secure authentication/authorization patterns and best practices for production deployments.',
      'Set up CI/CD pipelines with GitHub Actions to automate lint/test/build and deployment workflows.',
      'Collaborated with designers to translate Figma/briefs into pixel-perfect, accessible components (WCAG 2.1 AA).',
    ],
    technologies: ['Python', 'Django', 'React', 'Next.js', 'TypeScript', 'JavaScript', 'PostgreSQL', 'Docker', 'Git', 'GitHub Actions', 'CI/CD'],
  },
  {
